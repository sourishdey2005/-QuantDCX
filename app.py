...
def page_market_analysis():
    ...
    with tabs1[0]:
        ...
        st.plotly_chart(fig, use_container_width=True)
    with tabs1[1]:
        st.plotly_chart(heikin_ashi_chart(df), use_container_width=True)
    with tabs1[2]:
        st.plotly_chart(macd_chart(df), use_container_width=True)
    with tabs1[3]:
        st.plotly_chart(bb_chart(df), use_container_width=True)
    with tabs1[4]:
        st.plotly_chart(rsi_chart(df), use_container_width=True)
    with tabs1[5]:
        col1, col2 = st.columns(2)
        with col1:
            st.plotly_chart(volume_profile_chart(df), use_container_width=True)
        with col2:
            st.plotly_chart(obv_chart(df), use_container_width=True)
    with tabs1[6]:
        st.plotly_chart(stoch_rsi_chart(df), use_container_width=True)
    with tabs1[7]:
        st.plotly_chart(williams_r_chart(df), use_container_width=True)
    with tabs1[8]:
        st.plotly_chart(roc_chart(df), use_container_width=True)
    with tabs1[9]:
        st.plotly_chart(obv_chart(df), use_container_width=True)
    with tabs1[10]:
        st.plotly_chart(volatility_chart(df), use_container_width=True)
    with tabs1[11]:
        st.plotly_chart(zscore_chart(df), use_container_width=True)
    ...
    with tabs2[0]:
        st.plotly_chart(cci_chart(df), use_container_width=True)
    with tabs2[1]:
        st.plotly_chart(mfi_chart(df), use_container_width=True)
    with tabs2[2]:
        st.plotly_chart(adx_chart(df), use_container_width=True)
    with tabs2[3]:
        st.plotly_chart(stochastic_chart(df), use_container_width=True)
    with tabs2[4]:
        st.plotly_chart(ichimoku_chart(df), use_container_width=True)
    with tabs2[5]:
        st.plotly_chart(pivot_chart(df), use_container_width=True)
    with tabs2[6]:
        st.plotly_chart(fibonacci_chart(df), use_container_width=True)
    with tabs2[7]:
        st.plotly_chart(ease_of_movement_chart(df), use_container_width=True)
    with tabs2[8]:
        st.plotly_chart(force_index_chart(df), use_container_width=True)
    with tabs2[9]:
        st.plotly_chart(mass_index_chart(df), use_container_width=True)
    with tabs2[10]:
        st.plotly_chart(kst_chart(df), use_container_width=True)
    with tabs2[11]:
        st.plotly_chart(supertrend_chart(df), use_container_width=True)
    ...
    with tabs3[0]:
        st.plotly_chart(realized_volatility_chart(df), use_container_width=True)
    with tabs3[1]:
        st.plotly_chart(momentum_chart(df), use_container_width=True)
    with tabs3[2]:
        st.plotly_chart(tsi_chart(df), use_container_width=True)
    with tabs3[3]:
        st.plotly_chart(ulcer_index_chart(df), use_container_width=True)
    with tabs3[4]:
        st.plotly_chart(kama_chart(df), use_container_width=True)
    with tabs3[5]:
        st.plotly_chart(elder_ray_chart(df), use_container_width=True)
    with tabs3[6]:
        st.plotly_chart(vortex_chart(df), use_container_width=True)
    with tabs3[7]:
        st.plotly_chart(aroon_chart(df), use_container_width=True)
    with tabs3[8]:
        st.plotly_chart(copp_curve_chart(df), use_container_width=True)
    with tabs3[9]:
        st.plotly_chart(vwap_bandwidth_chart(df), use_container_width=True)
    with tabs3[10]:
        st.plotly_chart(keltner_width_chart(df), use_container_width=True)
    with tabs3[11]:
        st.plotly_chart(money_flow_volume_chart(df), use_container_width=True)
    ...
    with tabs4[0]:
        st.plotly_chart(pvt_chart(df), use_container_width=True)
    with tabs4[1]:
        st.plotly_chart(aroon_oscillator_chart(df), use_container_width=True)
    with tabs4[2]:
        st.plotly_chart(trend_intensity_chart(df), use_container_width=True)
    with tabs4[3]:
        st.plotly_chart(dpo_chart(df), use_container_width=True)
    with tabs4[4]:
        st.plotly_chart(log_returns_chart(df), use_container_width=True)
    with tabs4[5]:
        st.plotly_chart(Arnaud_Legaux_chart(df), use_container_width=True)
    with tabs4[6]:
        st.plotly_chart(keltner_filled_chart(df), use_container_width=True)
    with tabs4[7]:
        st.plotly_chart(multi_sma_chart(df), use_container_width=True)
    with tabs4[8]:
        st.plotly_chart(multi_ema_chart(df), use_container_width=True)
    with tabs4[9]:
        st.plotly_chart(hull_ma_chart(df), use_container_width=True)
    with tabs4[10]:
        st.plotly_chart(wma_chart(df), use_container_width=True)
    with tabs4[11]:
        st.plotly_chart(donchian_filled_chart(df), use_container_width=True)
...
def page_trade_flow():
    ...
    with tabs1[0]:
        st.plotly_chart(trade_bubble_chart(trades), use_container_width=True)

    with tabs1[1]:
        st.plotly_chart(buy_sell_pressure(trades), use_container_width=True)
    ...
    with tabs1[4]:
        if viz_mode == "3D Advanced":
            st.plotly_chart(trades_scatter_3d(trades), use_container_width=True)
        else:
...
def page_advanced():
    ...
    with tabs1[0]:
        st.plotly_chart(cumulative_returns_chart(df), use_container_width=True)
    ...
    with tabs2[0]:
        st.plotly_chart(price_surface_3d(df), use_container_width=True)

    with tabs2[1]:
        st.plotly_chart(volatility_surface_3d(df), use_container_width=True)
...
def page_multi_compare():
    ...
    with tabs[0]:
        st.plotly_chart(multi_asset_comparison(price_dict), use_container_width=True)

    with tabs[1]:
        st.plotly_chart(correlation_heatmap(price_dict), use_container_width=True)
